    ...
    return (
        <div className='User-Account-Container'>
            <div className='User-Account-Header-Container'>
                <div className='User-Account-Header-Title-Container'>
                    <h3 className='User-Account-Header-Title'>Manage Your Vision's ID</h3>
                    <p className='User-Account-Header-Description'>Manage your information that you share with us.</p>
                </div>
            </div>
            <div className='User-Account-Fields-Container'>
                {[
                    {
            ...
            <div className='User-Account-Bottom-Container'>
                <Button 
